    ...
    <body style="margin:0;padding:0;background:#F7F5FF;font-family:Arial,sans-serif;">
      <div style="max-width:560px;margin:40px auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(107,86,200,0.1);">
        ...
        <div style="background:linear-gradient(135deg,#120F2A,#3D3660);padding:32px 36px;">
          <div style="font-size:11px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:rgba(196,181,244,0.7);margin-bottom:6px;">Quote Request Received</div>
          <div style="font-size:26px;font-weight:700;color:white;letter-spacing:0.04em;">${ref}</div>
          <div style="font-size:14px;color:rgba(255,255,255,0.5);margin-top:4px;">${projectName}</div>
        </div>

        <div style="padding:28px 36px;">
          <p style="font-size:15px;color:#333;line-height:1.7;margin:0 0 20px;">Hi ${name.split(' ')[0]},</p>
          <p style="font-size:14px;color:#555;line-height:1.7;margin:0 0 24px;">
            Thanks for reaching out — we've received your quote request for <strong>${projectName}</strong>
            and will have a detailed proposal back to you within <strong>48 hours</strong>.
          </p>

          <div style="background:#F7F5FF;border-radius:10px;padding:18px 20px;margin-bottom:24px;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:#9B87E8;padding-bottom:12px;" colspan="2">Your Request</td></tr>
              ...
              <tr><td style="font-size:13px;color:#888;padding:4px 0;">Project</td><td style="font-size:13px;color:#333;text-align:right;">${projectName}</td></tr>
              ${projectType ? `<tr><td style="font-size:13px;color:#888;padding:4px 0;">Type</td><td style="font-size:13px;color:#333;text-align:right;">${projectType}</td></tr>` : ''}
              ${city ? `<tr><td style="font-size:13px;color:#888;padding:4px 0;">Location</td><td style="font-size:13px;color:#333;text-align:right;">${city}</td></tr>` : ''}
              <tr><td style="font-size:13px;color:#888;padding:4px 0;">Complexity</td><td style="font-size:13px;color:#333;text-align:right;">${complexityLabel}</td></tr>
              <tr><td style="font-size:13px;color:#888;padding:4px 0;">Timeline</td><td style="font-size:13px;color:#333;text-align:right;">${timelineLabel}</td></tr>
              ${estimateLow ? `<tr><td style="font-size:13px;color:#888;padding:4px 0;">Estimate Range</td><td style="font-size:13px;color:#333;font-weight:600;text-align:right;">$${estimateLow.toLocaleString()} – $${estimateHigh.toLocaleString()}</td></tr>` : ''}
            </table>
          </div>
          ...
          <div style="margin-bottom:24px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr><td style="padding:6px 0;font-size:13px;color:#333;">1.&nbsp;&nbsp;We review your project brief and reference materials</td></tr>
              <tr><td style="padding:6px 0;font-size:13px;color:#333;">2.&nbsp;&nbsp;A detailed quote is sent to you within 48 hours</td></tr>
              <tr><td style="padding:6px 0;font-size:13px;color:#333;">3.&nbsp;&nbsp;Accept the quote and production begins immediately</td></tr>
            </table>
          </div>

          <p style="font-size:13px;color:#888;line-height:1.7;margin:0 0 8px;">
            In the meantime, feel free to reply to this email with any additional details or questions.
          </p>
        </div>
